...
function Commenter() {
    ...
    return (
        <div style={{ border: "1px solid black" }}>
            <div
                style={{ borderBottom: "1px solid black", height: 150, width: 400, padding: 16, overflowY: "auto" }}>
                {comments.map((comment) => (
                    <p style={{ fontSize: 12, borderBottom: "1px solid black", marginTop: 8, display: "flex", flexWrap: "wrap" }}>{comment}</p>
                ))}
